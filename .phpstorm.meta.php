...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./Users/clementgrihon/Perso/okaeri-laravel/public/storage' => 'string',
            'homeassistant.url' => 'string',
            'homeassistant.token' => 'string',
            'homeassistant.latitude' => 'string',
            'homeassistant.longitude' => 'string',
            'homeassistant.timezone' => 'string',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./Users/clementgrihon/Perso/okaeri-laravel/public/storage','homeassistant.url','homeassistant.token',
'homeassistant.latitude','homeassistant.longitude','homeassistant.timezone','inertia.ssr.enabled','inertia.ssr.url',
...
'mail.markdown.paths','mail.markdown.extensions','metno.user_agent','queue.default','queue.connections.sync.driver',
...
'boost.browser-logs','home','storage.local','storage.local.upload',);
...
'REDIS_CLIENT','REDIS_HOST','REDIS_PASSWORD','REDIS_PORT','VITE_APP_NAME',
'HOME_ASSISTANT_URL','HOME_ASSISTANT_TOKEN','LATITUDE','LONGITUDE','TIMEZONE',
'MET_NO_USER_AGENT',);
