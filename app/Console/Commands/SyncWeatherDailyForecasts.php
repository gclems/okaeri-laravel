...
use App\Domains\Domo\Actions\StoreWeatherDailyForecastsAction;
...
#[Signature('app:sync-weather-daily-forecasts')]
#[Description('Fetches the daily weather forecast for every weather entity from Home Assistant')]
class SyncWeatherDailyForecasts extends Command
{
    /**
    ...
    public function handle(
        ...
        foreach ($weatherEntities as $entity) {
            ...
            $storeWeatherDailyForecasts->execute(
