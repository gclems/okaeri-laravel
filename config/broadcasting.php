    ...
    'connections' => [
        ...
        'reverb' => [
            ...
            'client_options' => [
                ...
                // Bounded so a slow/unreachable Reverb can't block the synchronous
                // ha-listener daemon indefinitely (it can't be interrupted by
                // SIGTERM/SIGINT while blocked in this call).
                'connect_timeout' => 5,
                'timeout' => 5,
            ],
        ],
