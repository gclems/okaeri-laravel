...
readonly level: WeatherAlertLevel | null,
readonly risks: Record<string, WeatherAlertLevel>,
readonly id: number,
};
export type WeatherAlertLevel = 'Vert' | 'Jaune' | 'Orange' | 'Rouge';
...
readonly alert: WeatherAlert | null,
readonly id: number,
readonly name: string,
readonly isActive: boolean,
readonly type: DeviceType,
